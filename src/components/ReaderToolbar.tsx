...
export function ReaderToolbar({
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-stone-200/75 bg-[#f7f1e7]/90 px-3 py-3 backdrop-blur dark:border-stone-800 dark:bg-stone-950/90">
      <div className="mx-auto flex max-w-5xl items-center gap-2">
        <button
          type="button"
          onClick={onBack}
          className="inline-flex h-11 w-11 items-center justify-center rounded-full text-stone-700 transition hover:bg-stone-200/70 dark:text-stone-200 dark:hover:bg-stone-800"
